...
public:
    ...
    bool connect_to_goal_when_over_precipice = true;
    ...
    virtual PlainAstarData reconstruct_path(
        std::unordered_map<uint64_t, AStarCell> closed_heap, 
        glm::ivec3 pos, 
        GroundAdjustingState last_point_state = GroundAdjustingState::FOUND_GROUND);
