...
DescriptorSetLayout PipelinePassBuilder::create_descriptor_set_layout(VulkanDevice& device) {
    ...
    return DescriptorSetLayout(device, m_dsl_builder);
}
