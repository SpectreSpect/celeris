...
std::unique_ptr<LidarScan> NewLidarScanReceiver::try_get_lidar_scan_from_lidar_msg(
...
std::unique_ptr<LidarScan> NewLidarScanReceiver::try_pop_front_lidar_scan() {
    LOG_METHOD();
...
bool NewLidarScanReceiver::read_exact_message(int client_socket, LidarMessage& message) {
