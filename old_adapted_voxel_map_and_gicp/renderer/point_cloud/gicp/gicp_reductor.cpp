...
OldGICPReductor::OldGICPReductor(VulkanEngine& engine, ComputePassManager& compute_pass_manager) 
    :   engine(engine),
        gicp_reduce_pass(compute_pass_manager.old_gicp_reduce_cp, compute_pass_manager.descriptor_pool()),
...
uint32_t OldGICPReductor::reduce_step(VulkanBuffer& partial_src, VulkanBuffer& partial_dst, const uint32_t input_count) {
...
OldGICPReductor::GICPPartial OldGICPReductor::reduce(VulkanBuffer& partial_src, VulkanBuffer& partial_dst, uint32_t input_count) {
