...
OldVoxelMapPointReseter::OldVoxelMapPointReseter(VulkanEngine& engine, ComputePassManager& compute_pass_manager) 
    :   engine(engine),
        reset_pass(compute_pass_manager.old_reset_voxel_point_map_cp, compute_pass_manager.descriptor_pool()),
...
void OldVoxelMapPointReseter::reset(OldVoxelPointMap& voxel_point_map) {
    LOG_METHOD();
