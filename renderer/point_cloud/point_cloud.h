...
public:
    ...
    PointCloud(VulkanEngine& engine, Mesh& mesh, SlotPassInstance& material);
    ...
    PointCloud(VulkanEngine& engine, Mesh& mesh, SlotPassInstance& material, InstanceBatch instance_batch);
    ...
    PointCloud(VulkanEngine& engine, Mesh& mesh, SlotPassInstance& material, VulkanBuffer& instance_buffer, uint32_t instance_count);
    ...
    PointCloud(VulkanEngine& engine, Mesh& mesh, SlotPassInstance& material, uint32_t instance_count);
